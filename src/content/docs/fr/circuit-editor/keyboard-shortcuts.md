...
description: Tous les raccourcis clavier de l'éditeur Velxio.
sidebar:
  order: 5
---
...
Les raccourcis d'édition standard auxquels vous vous attendez (sélection, duplication, bascule de commentaire) fonctionnent dans l'éditeur de code.
