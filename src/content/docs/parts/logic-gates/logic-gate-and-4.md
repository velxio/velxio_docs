...
Add it from the [component picker](/docs/circuit-editor/placing-components/) — search for “AND Gate (4-input)” (tags: logic, gate, and, 4-input, digital).
