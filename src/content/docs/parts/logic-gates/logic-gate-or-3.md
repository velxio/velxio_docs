...
Add it from the [component picker](/docs/circuit-editor/placing-components/) — search for “OR Gate (3-input)” (tags: logic, gate, or, 3-input, digital).
