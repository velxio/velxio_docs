---
title: "Resistor (custom)"
description: "Resistor (custom) — Passive part in the Velxio catalog."
---
...
Add it from the [component picker](/docs/circuit-editor/placing-components/) — search for “Resistor (custom)” (tags: resistor).
