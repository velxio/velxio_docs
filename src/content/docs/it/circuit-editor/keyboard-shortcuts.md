...
description: Tutte le scorciatoie da tastiera nell'editor Velxio.
sidebar:
  order: 5
---
...
Le scorciatoie di modifica standard che ti aspetti (selezione, duplicazione,
attivazione/disattivazione commenti) funzionano all'interno dell'editor di codice.
