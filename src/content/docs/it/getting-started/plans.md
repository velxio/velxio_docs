...
description: Cosa ottieni gratuitamente e cosa sbloccano i piani Maker e Pro.
sidebar:
  order: 7
---

Puoi creare, simulare e condividere circuiti su Velxio **gratuitamente** — il
simulatore principale, il catalogo aperto di schede, la galleria di esempi e i
progetti pubblici non costano nulla.
...
L'assistente AI misura l'utilizzo in **cicli** (mostrati in fondo al pannello
della chat, con quote giornaliere e mensili che dipendono dal tuo piano).

Per i prezzi attuali e il confronto completo, consulta la
[pagina dei prezzi](https://velxio.dev/pricing). Per abbonarti o gestire un
abbonamento, consulta [Abbonamento](/docs/it/account/overview/).
