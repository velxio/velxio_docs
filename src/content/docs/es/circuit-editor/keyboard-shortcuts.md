...
description: Todos los atajos de teclado en el editor de Velxio.
sidebar:
  order: 5
---
...
Los atajos de edición estándar que espera (seleccionar, duplicar,
alternar comentarios) funcionan dentro del editor de código.
