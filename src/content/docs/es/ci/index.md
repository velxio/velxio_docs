---
title: Velxio CI
description: Ejecuta tu firmware en una placa simulada desde una terminal o un trabajo de CI, y haz que la compilación falle cuando el firmware se comporte mal.
sidebar:
  order: 1
  badge:
    text: Paid
...
- **Probar lo que no puedes tener en un escritorio.** Todas las placas que Velxio simula están
  disponibles para cada trabajo, en paralelo, sin laboratorio y sin flashear.
...
| Plan  | Minutos de CI al mes | Trabajos a la vez | Duración máxima |
| ----- | -------------------- | ----------------- | --------------- |
| Free  | ninguno              | ninguno           | ninguna         |
| Maker | 200                  | 1                 | 5 min           |
| Pro   | 2.000                | 2                 | 10 min          |

Una ejecución que nunca comienza (una placa desconocida, un firmware que no coincide con la
placa, un escenario rechazado) no cuesta nada. Los minutos se restablecen el día primero del
mes, UTC. Tu saldo, tu historial de ejecuciones y tus tokens están en
[/account/ci](https://velxio.dev/account/ci):

![La página de cuenta de CI: minutos usados este mes, los tokens que existen con cuándo se usó cada uno por última vez, y una tabla de ejecuciones recientes con su estado, segundos simulados y facturados y código de salida](../../../../assets/docs/ci/account.png)
