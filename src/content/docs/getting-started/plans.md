...
core simulator, the open board catalog, the examples gallery and public
projects don't cost anything.
...
The AI assistant meters usage in **cycles** (shown at the bottom of the
chat panel, with daily and monthly allowances that depend on your plan).

For current prices and the full comparison, see the
[pricing page](https://velxio.dev/pricing). To subscribe or manage a
subscription, see [Subscription](/docs/account/overview/).
