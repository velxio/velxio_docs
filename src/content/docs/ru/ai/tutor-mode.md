...
Because the simulator is real ([really running firmware](/docs/ru/getting-started/faq/)),
everything the tutor teaches is verifiable on the spot: measure it with
the [oscilloscope](/docs/ru/instruments/oscilloscope/), read it in the
[serial monitor](/docs/ru/programming/serial-monitor/).

Tutor mode shares the same **cycles** quota as the other modes — see
[plans](/docs/ru/getting-started/plans/).
