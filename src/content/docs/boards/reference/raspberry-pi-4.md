...
The Cortex-A72 Pi. Same Linux workflow as the
[Pi 3](/docs/boards/reference/raspberry-pi-3/) — shell, Python, `gpiozero`
against the real canvas — on a faster CPU profile.

Choose it over the Pi 3 when you are prototyping for a Pi 4 specifically;
for pure GPIO work the two behave the same.
