...
description: Every board you can simulate in Velxio, by family.
sidebar:
  order: 1
---

Velxio simulates boards from seven families. Some run entirely in your
browser; larger ones run on Velxio's cloud emulators — you don't have to do
anything different, it just works when you press Play.

| Family               | Boards                                                                                                                    | Languages                                                     |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
...
| Seeed XIAO           | ESP32S3 Sense, ESP32C6, RP2040, RP2350, nRF52840 Sense, SAMD21, RA4M1, MG24 Sense, nRF54L15 Sense, the IPS Display boards | Arduino C++ (MicroPython on the ESP32 and RP2040/RP2350 ones) |
